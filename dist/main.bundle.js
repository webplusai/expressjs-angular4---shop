...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_crud_service__ = __webpack_require__("../../../../../src/app/services/crud.service.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_2__angular_material__["f" /* NativeDateAdapter */],
            __WEBPACK_IMPORTED_MODULE_5__services_crud_service__["a" /* CRUDService */]
        ],
...
var CRUDService = (function () {
    function CRUDService(http) {
        this.http = http;
        this.endPoint = 'api/crud';
    }
    CRUDService.prototype.create = function (data) {
        return this.http.post(this.endPoint, data, httpOptions);
    };
    CRUDService.prototype.retrieve = function (model) {
        return this.http.get(this.endPoint + '?model=' + model);
    };
    CRUDService.prototype.retrieveCondition = function (model, condition) {
        return this.http.get(this.endPoint + '?model=' + model + '&condition=' + condition);
    };
    CRUDService.prototype.retrieveOne = function (model, id) {
        return this.http.get(this.endPoint + '/' + id + '?model=' + model);
    };
    CRUDService.prototype.update = function (data, id) {
        return this.http.put(this.endPoint + '/' + id, data, httpOptions);
    };
    return CRUDService;
}());
