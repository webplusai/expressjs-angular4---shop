...
@Component({
	selector: 'admin-super-administrator-list',
	templateUrl: './super-administrator-list.component.html',
	styleUrls: [ './super-administrator-list.component.scss' ]
})
export class SuperAdministratorListComponent implements OnInit {
