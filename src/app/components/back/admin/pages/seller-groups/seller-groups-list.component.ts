...
@Component({
	...
	templateUrl: './seller-groups-list.component.html',
	styleUrls: ['./seller-groups-list.component.scss']
})
export class SellerGroupsListComponent implements OnInit {

	displayedColumns = ['name', 'description', 'actual_fee_rates', 'action'];
	tableData = new TableData();
	dataSource: SellerGroupDataSource | null;
...
export class SellerGroupDataSource extends DataSource<any> {
