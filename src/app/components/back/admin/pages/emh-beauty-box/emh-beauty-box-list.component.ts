...
@Component({
	selector: 'admin-emh-beauty-box-list',
	templateUrl: './emh-beauty-box-list.component.html',
	styleUrls: ['./emh-beauty-box-list.component.scss']
})
export class EmhBeautyBoxListComponent implements OnInit {
