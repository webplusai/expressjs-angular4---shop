...
@Component({
	selector: 'admin-spanish-list',
	templateUrl: './spanish-list.component.html',
	styleUrls: [ './spanish-list.component.scss' ]
})
export class SpanishListComponent implements OnInit {
