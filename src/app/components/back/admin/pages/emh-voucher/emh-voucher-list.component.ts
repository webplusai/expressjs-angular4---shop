...
@Component({
	selector: 'admin-emh-voucher-list',
	templateUrl: './emh-voucher-list.component.html',
	styleUrls: ['./emh-voucher-list.component.scss']
})
export class EmhVoucherListComponent implements OnInit {
